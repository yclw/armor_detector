...
class  LightParams{
public:
    LightParams(double min_ratio = 0.08,double max_ratio = 0.4,double max_angle = 40.0,int color_diff_thresh = 50):
    min_ratio(min_ratio),max_ratio(max_ratio),max_angle(max_angle),color_diff_thresh(color_diff_thresh){}
...
public:
    ArmorParams(double min_light_ratio = 0.6,double min_small_center_distance = 0.8,double max_small_center_distance = 3.2,
                ...
                min_light_ratio(min_light_ratio),min_small_center_distance(min_small_center_distance),max_small_center_distance(max_small_center_distance),
